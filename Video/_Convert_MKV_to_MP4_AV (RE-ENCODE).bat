...
-map 0:s:0? ^
-map 0:s:1? ^
-c:v:0 libx264 -crf:v:0 18 -x264-params level=4.0:mixed-refs=0:vbv-bufsize=25000:vbv-maxrate=20000:rc-lookahead=10:ref=6:bframes=5:b-adapt=2:me=umh:merange=32 ^
-c:a:0 copy ^
-c:a:1 copy ^
-c:a:2 copy ^
-c:a:3 copy ^
...
-metadata:s:s:1 language=eng -metadata:s:s:1 title="Closed Captions" ^
"%%~nA - outfile.mp4"
