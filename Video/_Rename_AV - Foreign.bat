...
-metadata:s:a:1 language=eng -metadata:s:a:1 title="Surround (DTS)" ^
-metadata:s:a:2 language=eng -metadata:s:a:2 title="Stereo (AAC)" ^
-metadata:s:a:3 language=jpn -metadata:s:a:3 title="Surround (AC3)" ^
-metadata:s:a:4 language=jpn -metadata:s:a:4 title="Surround (DTS)" ^
-metadata:s:a:5 language=jpn -metadata:s:a:5 title="Stereo (AAC)" ^
