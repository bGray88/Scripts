...
-map 0:s:0? ^
-map 0:s:1? ^
-video_track_timescale 90000 -ss 01:23:30.25 -to 01:24:34.50 ^
-c:v:0 libx264 ^
-vf crop=924:714:174:2,scale=720:480,fade=t=in:st=5010.25:d=0.5,fade=t=out:st=5074.00:d=0.5 ^
...
-filter:a afade=t=in:st=5010.25:d=0.5,afade=t=out:st=5074.00:d=0.5 ^
