...
-map 0:s:0? ^
-map 0:s:1? ^
-video_track_timescale 90000 -ss 00:00:00.10 -to 00:09:54.90 ^
-c:v:0 libx264 ^
-vf scale=720:480,fade=t=in:st=00.00:d=0,fade=t=out:st=100000.00:d=0 ^
...
-filter:a "afade=t=in:st=00.00:d=0, afade=t=out:st=100000.00:d=0" ^
