...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 409890 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq StrangerOfSwordCity.exe" /NH | find /I /N "StrangerOfSwordCity.exe" >NUL
