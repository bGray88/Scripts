...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 745330 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq StrikeForce Kitty.exe" /NH | find /I /N "StrikeForce Kitty.exe" >NUL
