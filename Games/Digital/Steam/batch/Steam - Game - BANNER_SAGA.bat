...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 237990 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq The Banner Saga.exe" /NH | find /I /N "The Banner Saga.exe" >NUL
