...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 859680 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Deep Space Waifu Fantasy.exe" /NH | find /I /N "Deep Space Waifu Fantasy.exe" >NUL
