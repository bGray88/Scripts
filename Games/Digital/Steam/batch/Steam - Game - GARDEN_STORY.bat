...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1062140 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq ${Garden Story}.exe" /NH | find /I /N "${Garden Story}.exe" >NUL
