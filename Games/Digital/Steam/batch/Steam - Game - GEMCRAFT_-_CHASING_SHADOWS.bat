...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 296490 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq GemCraft Chasing Shadows.exe" /NH | find /I /N "GemCraft Chasing Shadows.exe" >NUL
