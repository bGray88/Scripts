...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 242680 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq nuclearthrone.exe" /NH | find /I /N "nuclearthrone.exe" >NUL
