...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 785790 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq WHAT THE GOLF.exe" /NH | find /I /N "WHAT THE GOLF.exe" >NUL
