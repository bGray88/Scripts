...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 489830 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq SkyrimSELauncher.exe" /NH | find /I /N "SkyrimSELauncher.exe" >NUL
