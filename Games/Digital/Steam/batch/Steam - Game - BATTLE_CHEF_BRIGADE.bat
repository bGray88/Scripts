...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 452570 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq BattleChefBrigade.exe" /NH | find /I /N "BattleChefBrigade.exe" >NUL
