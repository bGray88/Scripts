...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1140890 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Morbid - The Seven Acolytes.exe" /NH | find /I /N "Morbid - The Seven Acolytes.exe" >NUL
