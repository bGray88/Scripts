...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 212800 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq supercratebox.exe" /NH | find /I /N "supercratebox.exe" >NUL
