...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 487350 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq PiratePopPlus.exe" /NH | find /I /N "PiratePopPlus.exe" >NUL
