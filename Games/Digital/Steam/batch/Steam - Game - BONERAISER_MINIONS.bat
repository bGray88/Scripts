...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1944570 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Boneraiser Minions.exe" /NH | find /I /N "Boneraiser Minions.exe" >NUL
