...
start "" "%~dp0..\steam.exe" -silent -applaunch 501590 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq StormGame-Win64-Shipping.exe" /NH | find /I /N "StormGame-Win64-Shipping.exe" >NUL
