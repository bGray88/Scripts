...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 585910 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq WildGunsReloaded.exe" /NH | find /I /N "WildGunsReloaded.exe" >NUL
