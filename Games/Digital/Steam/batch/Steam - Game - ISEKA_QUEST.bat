...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1268110 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq ISEKAI QUEST.exe" /NH | find /I /N "ISEKAI QUEST.exe" >NUL
