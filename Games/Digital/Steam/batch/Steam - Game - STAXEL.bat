...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 405710 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Staxel.Client.exe" /NH | find /I /N "Staxel.Client.exe" >NUL
