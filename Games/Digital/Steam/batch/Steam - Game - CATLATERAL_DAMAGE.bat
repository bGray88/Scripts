...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 329860 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq CatlateralDamage.exe" /NH | find /I /N "CatlateralDamage.exe" >NUL
