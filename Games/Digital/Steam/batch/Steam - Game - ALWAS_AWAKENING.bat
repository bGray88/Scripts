...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 549260 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq AlwasAwakening.exe" /NH | find /I /N "AlwasAwakening.exe" >NUL
