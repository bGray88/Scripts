...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 639790 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Deep Space Waifu.exe" /NH | find /I /N "Deep Space Waifu.exe" >NUL
