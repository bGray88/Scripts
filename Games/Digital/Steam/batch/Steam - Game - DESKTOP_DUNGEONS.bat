...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 226620 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq DesktopDungeons.exe" /NH | find /I /N "DesktopDungeons.exe" >NUL
