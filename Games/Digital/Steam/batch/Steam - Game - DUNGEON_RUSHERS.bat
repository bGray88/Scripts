...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 429620 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Dungeon Rushers.exe" /NH | find /I /N "Dungeon Rushers.exe" >NUL
