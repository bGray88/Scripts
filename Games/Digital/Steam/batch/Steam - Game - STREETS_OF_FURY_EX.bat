...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 350910 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Streets of Fury EX.exe" /NH | find /I /N "Streets of Fury EX.exe" >NUL
