...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 259550 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Hero of the Kingdom.exe" /NH | find /I /N "Hero of the Kingdom.exe" >NUL
