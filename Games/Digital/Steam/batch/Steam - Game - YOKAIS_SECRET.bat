...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1146630 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Yokai's Secret.exe" /NH | find /I /N "Yokai's Secret.exe" >NUL
