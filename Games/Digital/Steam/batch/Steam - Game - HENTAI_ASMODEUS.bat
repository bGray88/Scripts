...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1147510 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Hentai Asmodeus.exe" /NH | find /I /N "Hentai Asmodeus.exe" >NUL
