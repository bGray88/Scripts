...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 603530 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq ARobotNamedFight.exe" /NH | find /I /N "ARobotNamedFight.exe" >NUL
