...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 8870 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq BioShockInfinite.exe" /NH | find /I /N "BioShockInfinite.exe" >NUL
