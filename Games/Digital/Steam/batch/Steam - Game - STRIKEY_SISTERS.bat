...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 643880 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq strikey_sisters.exe" /NH | find /I /N "strikey_sisters.exe" >NUL
