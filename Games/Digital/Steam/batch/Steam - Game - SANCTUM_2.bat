...
start "" "%~dp0..\steam.exe" -silent -applaunch 210770 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq SanctumGame-Win32-Shipping.exe" /NH | find /I /N "SanctumGame-Win32-Shipping.exe" >NUL
