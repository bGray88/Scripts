...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1333470 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Alex Kidd in Miracle World DX.exe" /NH | find /I /N "Alex Kidd in Miracle World DX.exe" >NUL
