...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 595140 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq ImmortalRedneck.exe" /NH | find /I /N "ImmortalRedneck.exe" >NUL
