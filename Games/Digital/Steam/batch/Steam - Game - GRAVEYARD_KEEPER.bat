...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 599140 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Graveyard Keeper.exe" /NH | find /I /N "Graveyard Keeper.exe" >NUL
