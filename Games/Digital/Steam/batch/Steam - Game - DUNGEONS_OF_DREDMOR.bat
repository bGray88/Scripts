...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 98800 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Dungeons of Dredmor.exe" /NH | find /I /N "Dungeons of Dredmor.exe" >NUL
