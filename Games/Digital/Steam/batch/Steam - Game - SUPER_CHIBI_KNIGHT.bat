...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 283080 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq SuperChibiKnight.exe" /NH | find /I /N "SuperChibiKnight.exe" >NUL
