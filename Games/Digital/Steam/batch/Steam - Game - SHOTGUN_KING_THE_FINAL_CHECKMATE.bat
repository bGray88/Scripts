...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1972440 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq shotgun_king.exe" /NH | find /I /N "shotgun_king.exe" >NUL
