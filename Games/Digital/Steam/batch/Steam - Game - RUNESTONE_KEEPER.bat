...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 339400 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq RuneStoneKeeper.exe" /NH | find /I /N "RuneStoneKeeper.exe" >NUL
