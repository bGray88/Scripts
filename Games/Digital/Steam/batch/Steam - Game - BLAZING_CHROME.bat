...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 609110 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Blazing Chrome.exe" /NH | find /I /N "Blazing Chrome.exe" >NUL
