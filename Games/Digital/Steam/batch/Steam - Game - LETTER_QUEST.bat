...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 373970 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq letterquestremastered.exe" /NH | find /I /N "letterquestremastered.exe" >NUL
