...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1929870 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Nomad Survival.exe" /NH | find /I /N "Nomad Survival.exe" >NUL
