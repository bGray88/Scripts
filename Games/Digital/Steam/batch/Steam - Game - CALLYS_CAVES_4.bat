...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 642580 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Cally's Caves 4.exe" /NH | find /I /N "Cally's Caves 4.exe" >NUL
