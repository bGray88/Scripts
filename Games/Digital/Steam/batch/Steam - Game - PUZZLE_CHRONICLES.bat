...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 19020 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq PuzzleChronicles.exe" /NH | find /I /N "PuzzleChronicles.exe" >NUL
