...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1710100 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Bing in Wonderland.exe" /NH | find /I /N "Bing in Wonderland.exe" >NUL
