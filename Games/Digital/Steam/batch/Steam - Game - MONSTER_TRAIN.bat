...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1102190 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq MonsterTrain.exe" /NH | find /I /N "MonsterTrain.exe" >NUL
