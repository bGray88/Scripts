...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 494430 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq Praey For the Gods.exe" /NH | find /I /N "Praey For the Gods.exe" >NUL
