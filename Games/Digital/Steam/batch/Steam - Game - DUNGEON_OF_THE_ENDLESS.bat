...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 249050 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq DungeonoftheEndless.exe" /NH | find /I /N "DungeonoftheEndless.exe" >NUL
