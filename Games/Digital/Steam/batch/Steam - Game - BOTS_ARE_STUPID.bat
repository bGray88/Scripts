...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 1578160 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq BotsAreStupid.exe" /NH | find /I /N "BotsAreStupid.exe" >NUL
