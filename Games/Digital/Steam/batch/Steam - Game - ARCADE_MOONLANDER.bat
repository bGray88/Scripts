...
start "" "%~dp0..\steam.exe" -silent -nochatui -nofriendsui -applaunch 727020 -fullscreen
...
:UpdateLoopStart
tasklist /FI "IMAGENAME eq ArcadeMoonlander+_v2.0.exe" /NH | find /I /N "ArcadeMoonlander+_v2.0.exe" >NUL
