...
Do While objListFile = ""
	...
	ElseIf Not FileExists(objListFile) Then
		MsgBox("The File Does Not Exist, Quitting")
		objListFile = ""
	ElseIf Not IsFileType(objListFile, ".txt") Then
		MsgBox("The File Is Not A Text File, Quitting")
		objListFile = ""
	End If
Loop
...
Dim objTextStream
Dim objTextStream : Set objTextStream = objFSO.OpenTextFile(strFullListPath, ForReading, _
		blnCreateFileFalse)
