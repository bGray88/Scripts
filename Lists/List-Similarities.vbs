...
Dim strFileFolder : strFileFolder = BrowseForFolder( "Find the file directory", "" )
If Not FolderExists(strFileFolder) Then
	MsgBox("The Folder Does Not Exist, Quitting")
	Set objFSO = Nothing
	WScript.Quit(1)
ElseIf FolderEmpty(strFileFolder) Then
	MsgBox("The Folder Is Empty, Quitting")
	Set objFSO = Nothing
	WScript.Quit(1)
End If
Dim strPathFileFolderName : strPathFileFolderName = GetFileFolderName(strFileFolder)

Dim strMediaFolder : strMediaFolder = BrowseForFolder( "Find the media directory", "" )
...
Dim strListTitle : strListTitle = "Similarities (" & strPathFileFolderName & _
